module double_or_nothing::random_utils {
    ...
    public(package) fun weighted_random_choice<T: copy + drop>(weights:vector<u64>, values: vector<T>, rg: &mut RandomGenerator): T {
    ...
    fun weighted_random_test() {
        ...
        1000u64.do!(|_| {
            ...
            let current_value = results.borrow_mut(random_value);
            *current_value = *current_value + 1;
        });

        values.do!(|value| {
            let value_count = *results.borrow(value);
